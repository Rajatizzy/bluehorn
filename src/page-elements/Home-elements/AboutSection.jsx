        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            ...
            <p className="para " data-aos="fade-up" data-aos-duration="1200">
              ...
              is a commitment. With a fixed-cost model that eliminates hidden
              markups, we engineer, finance, construct, and maintain solar
              plants across residential, commercial, and industrial segments.
              <br />
              <br />
